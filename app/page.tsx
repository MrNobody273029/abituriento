  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "გამოიყენე ჩვენი კვიზი — 7 კითხვით გამოვლენ შენი ინტერესები, ძლიერი მხარეები და ბიუჯეტი, შემდეგ გაჩვენებ კონკრეტულ სპეციალობებს შრომის ბაზრის სტატისტიკით.",
        },
      },
      {
        "@type": "Question",
